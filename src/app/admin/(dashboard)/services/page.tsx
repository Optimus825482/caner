...
interface ServiceItem {
  ...
  order: number;
  published: boolean;
  translations: { locale: string; title: string; summary: string }[];
  createdAt: string;
}
...
export default function AdminServices() {
  ...
  function getTitle(item: ServiceItem) {
    const tr =
                      ...
                      <TableCell>
                        {item.icon ? (
                          <div className="flex h-8 w-8 items-center justify-center rounded bg-zinc-800">
                            <span className="material-symbols-outlined text-lg text-(--arvesta-accent)">
                              {item.icon}
                            </span>
                          </div>
                        ) : (
                          <div className="flex h-8 w-8 items-center justify-center rounded bg-zinc-800 text-zinc-600 text-xs">
                            —
                          </div>
                        )}
                      </TableCell>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <strong>
                &quot;{deleteItem ? getTitle(deleteItem) : ""}&quot;
              </strong>
