...
export default function HeroClient({ slides }: { slides: Slide[] }) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-1 bg-linear-to-b from-black/80 via-black/45 to-black/85" />
      ...
      <div className="absolute bottom-10 right-10 z-2 hidden items-center gap-1 rounded-full border border-white/15 bg-black/35 px-3 py-1.5 font-ui text-[0.8rem] text-(--arvesta-text-muted) backdrop-blur-sm md:flex">
