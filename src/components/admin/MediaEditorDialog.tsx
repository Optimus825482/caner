...
export function MediaEditorDialog({
  ...
  const editorContent = (
    <>
      <div className={mode === "inline" ? "mb-4" : "px-5 pt-5 pb-2 shrink-0"}>
        <h2 className="font-ui text-lg font-semibold text-white">
          {t("title")}
        </h2>
        <p className="text-(--arvesta-text-muted) text-sm">
          {t("description")}
        </p>
      </div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="space-y-1.5">
                      ...
                      <Input
                        ...
                        max={100}
                        value={depthFocusX}
                        onChange={(e) => setDepthFocusX(Number(e.target.value))}
                      />
                    </div>
                    <div className="space-y-1.5">
                      <Label
                      ...
                      <Input
                        ...
                        max={100}
                        value={depthFocusY}
                        onChange={(e) => setDepthFocusY(Number(e.target.value))}
                      />
                    </div>
                  </div>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <div className="space-y-1.5">
                          ...
                          <Input
                            ...
                            onChange={(e) => setDepthColorFrom(e.target.value)}
                            className="h-9 w-full"
                          />
                        </div>
                        <div className="space-y-1.5">
      ...
      <div
        className={
          mode === "inline"
            ...
            : "px-5 pb-5 pt-0 flex gap-3 justify-end"
        }
      >
        <Button
          type="button"
  ...
  if (mode === "inline") {
    if (!open) return null;
    return (
      <div className="w-full bg-(--arvesta-bg-card) border border-white/10 rounded-xl text-white p-5 flex flex-col min-h-[600px]">
        {editorContent}
      </div>
    );
  }
